...
//SKU model sold
$sqlSkuModelSold ="Select sku, COUNT(sku) as sku_sold, Sum(`amount`) as sku_sold_each From settlementsit Where amount_description ='Principal' Group by sku ORDER BY `sku_sold` DESC";
