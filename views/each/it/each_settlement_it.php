<div class="container">
    ...
    function fill_settlement($conn) {
        $outputData = '';
        $sqlDropDownSettlementID = "SELECT  *  FROM `settlementsit` GROUP BY settlement_id ORDER BY settlement_start_date DESC;";
    ...
    ?>  
    <div class="container">  
        <label class="col-sm-3 control-label">Italy Settlement ID &amp; Date</label>
        <div class="col-sm-9">
