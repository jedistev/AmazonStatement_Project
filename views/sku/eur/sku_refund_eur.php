        ...
        <div class="col-lg-12 mx-auto">
            <div class="modal-body">
                ...
                <table class="table table-condensed table-bordered table-striped table-hover dt-responsove wrap" cellspacing="0" >  
                    <thead>  
                        <tr style="font-size: 11px; font-weight: bold; text-transform: uppercase; text-align: center;">  Total of SKU UNIT Refund in All Amazon Marketplace Europe
                        </tr>  
                    </thead>
                </table>
                <div class="row">
