<p class="text-center">France Marketplace Model Code</p>
<div class="container">
    <br>
    <br>
    <?php
    ...
    function fill_settlement($conn) {
        $outputData = '';
        $sqlDropDownSettlementID = "SELECT  *  FROM `settlementsfr` GROUP BY settlement_id DESC ORDER BY settlement_start_date DESC;";
