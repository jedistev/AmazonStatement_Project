    ...
    <body id="page-top">
        ...
        <div class="container">
            ...
            function fill_settlement($conn) {
                $outputData = '';
                $sqlDropDownSettlementID = "SELECT  *  FROM `settlementsit` GROUP BY settlement_id ORDER BY settlement_start_date ASC;";
        ...
        <script>
            ...
            $(document).ready(function () {
                $("#getSettlementbutton").click(function () {
                    ...
                    $.get("getlist/getsingleprod_it.php", {SettlementID: prodname}, function (getresult) {
